...
export const defaultDashboard: {
  ...
  widgets: [
    ...
    },
    {
      id: 'tracknotes',
      enabled: false,
      layout: { x: 600, y: 120, width: 420, height: 100 },
      config: {
        background: { opacity: 80 },
        showOnlyWhenOnTrack: true,
        sessionVisibility: { race: true, loneQualify: true, openQualify: true, practice: true, offlineTesting: true },
        triggerDistancePct: 0.003,
        notes: [],
      },
    },
    {
      ...
      enabled: false,
      layout: { x: 600, y: 240, width: 260, height: 120 },
      config: {
        background: { opacity: 80 },
        showOnlyWhenOnTrack: true,
        sessionVisibility: { race: true, loneQualify: true, openQualify: true, practice: true, offlineTesting: true },
        ranges: [{ fromKph: 0, toKph: 100 }, { fromKph: 100, toKph: 200 }],
      },
    },
    {
      id: 'stinthistory',
      enabled: false,
      layout: { x: 600, y: 380, width: 400, height: 140 },
      config: {
        background: { opacity: 80 },
        showOnlyWhenOnTrack: false,
        sessionVisibility: { race: true, loneQualify: true, openQualify: true, practice: true, offlineTesting: true },
    ...
    },
    {
      id: 'frictioncircle',
      enabled: false,
      layout: { x: 1040, y: 120, width: 180, height: 210 },
      config: {
        background: { opacity: 80 },
        showOnlyWhenOnTrack: true,
        sessionVisibility: { race: true, loneQualify: true, openQualify: true, practice: true, offlineTesting: true },
    ...
    },
    {
      id: 'brakepressure',
      enabled: false,
      layout: { x: 1040, y: 490, width: 220, height: 150 },
      config: {
        background: { opacity: 80 },
        showOnlyWhenOnTrack: true,
        sessionVisibility: { race: true, loneQualify: true, openQualify: true, practice: true, offlineTesting: true },
    ...
    },
    {
      ...
      enabled: false,
      layout: { x: 1280, y: 490, width: 220, height: 150 },
      config: {
        background: { opacity: 80 },
        showOnlyWhenOnTrack: true,
        sessionVisibility: { race: true, loneQualify: true, openQualify: true, practice: true, offlineTesting: true },
    ...
    },
    {
      id: 'trackclock',
      enabled: false,
      layout: { x: 1040, y: 660, width: 220, height: 80 },
      config: {
        background: { opacity: 80 },
        showOnlyWhenOnTrack: false,
        sessionVisibility: { race: true, loneQualify: true, openQualify: true, practice: true, offlineTesting: true },
    ...
    },
    {
      id: 'steeringmeter',
      enabled: false,
      layout: { x: 600, y: 540, width: 300, height: 100 },
      config: {
        background: { opacity: 80 },
        showOnlyWhenOnTrack: true,
        sessionVisibility: { race: true, loneQualify: true, openQualify: true, practice: true, offlineTesting: true },
    ...
    },
    {
      id: 'cruiseodometer',
      enabled: false,
      layout: { x: 600, y: 660, width: 300, height: 100 },
      config: {
        background: { opacity: 80 },
        showOnlyWhenOnTrack: true,
        sessionVisibility: { race: true, loneQualify: true, openQualify: true, practice: true, offlineTesting: true },
